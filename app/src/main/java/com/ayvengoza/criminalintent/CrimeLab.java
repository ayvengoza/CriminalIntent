...
import com.ayvengoza.criminalintent.database.CrimeBaseHelper;
import com.ayvengoza.criminalintent.database.CrimeCursorWraper;
import com.ayvengoza.criminalintent.database.CrimeDbSchema;
...
public class CrimeLab {
    ...
    public Crime getCrime(UUID id){
        CrimeCursorWraper cursor = queryCrimes(
